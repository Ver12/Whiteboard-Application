...
MainWindow::MainWindow(QQueue <bool> *tempQueue)
{
    // Create the ScribbleArea widget and make it
    // the central widget
    scribbleArea = new ScribbleArea(this,tempQueue);
...
void MainWindow::penColor()
{
   ...
   // emit sendPenInfo(scribbleArea->penColor(),scribbleArea->penWidth());
}
...
/*
void MainWindow::sendDrawingSlot(std::vector<std::vector<bool>>binarr){
    emit sendDrawing(binarr);
}

void MainWindow::sendClearSlot(){
    emit sendClear();
}


void MainWindow::receiveDrawingSlot(QPoint p1,QPoint p2){
    emit sendReceiveDrawing(p1,p2);
}

void MainWindow::receivePenInfo(QColor newColor,int newPenWidth){
    emit setReceivePenInfo(newColor,newPenWidth);
