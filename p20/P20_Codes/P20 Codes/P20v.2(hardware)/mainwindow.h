...
public:
    MainWindow(QQueue <bool> *tempqueue);
...
private slots:
    ...
    void penWidth();
    void about();
    //void sendDrawingSlot(std::vector<std::vector<bool>>binarr);
    //void sendClearSlot();
...
signals:
    /*
    void sendDrawing(std::vector<std::vector<bool>>);
    void sendPenInfo(QColor,int);
    void sendClear();
    */
